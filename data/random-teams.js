...
class RandomTeams extends Dex.ModdedDex {
	...
	randomSet(template, slot = 1, teamDetails = {}, isDoubles = false) {
		...
		if (this.format.id === 'gen7tiershift' || this.format.id === 'gen7randomscalemons' || this.format.id === 'gen7randomaveragemons') {
			level = 100;
		}
	...
	randomTeam() {
		...
		while (pokemonPool.length && pokemon.length < 6) {
			...
			if (this.format.id === 'gen7randomaveragemons' && (template.baseSpecies === 'Shedinja' || templateAbility === 'Huge Power' || templateAbility === 'Pure Power' || templateAbility === 'Fur Coat')) continue;
			...
			case 'PU':
				...
				break;
			case 'LC':
				if ((this.format.id === 'gen7randomscalemons' || this.format.id === 'gen7randomaveragemons') && lcCount > 1 && this.randomChance(4, 5)) continue;
				break;
